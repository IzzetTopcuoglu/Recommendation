...
movie = pd.read_csv('C:/Users/izzet/PycharmProjects/DSMLBC9/DSMLBC9- Ödevler/Modül_4_Tavsiye_Sistemleri/HYBRID_RECOMMENDER_PROJECT/movie.csv')
movie.head()
movie.shape


# UserID, film adı, filme verilen oy ve zaman bilgisini içeren veri seti
rating = pd.read_csv('C:/Users/izzet/PycharmProjects/DSMLBC9/DSMLBC9- Ödevler/Modül_4_Tavsiye_Sistemleri/HYBRID_RECOMMENDER_PROJECT/rating.csv')
rating.head()
rating.shape
...
common_movies.groupby(["userId",'title'])['rating'].mean().unstack()
